    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Manage and organize your scheduled events</p>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @forelse ($events as $event)
                                <tr class="group hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200">
                                    ...
                                    <td class="px-8 py-5 whitespace-nowrap">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-amber-100 to-orange-100 text-amber-800">
                                ...
                                <tr>
                                    <td colspan="7" class="px-8 py-16">
                                        <div class="text-center">
                                            ...
                                            <p class="text-sm text-gray-500 mb-6">Get started by creating your first event</p>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-4 border-t border-gray-200">
                    <div class="flex items-center justify-between text-sm text-gray-600">
                        <div class="flex items-center space-x-2">
                            ...
                            <span>{{ Str::plural('event', $events->count()) }} total</span>
                        </div>
